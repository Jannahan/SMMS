...
public final class MysqlErrorNumbers {
    ...
    public final static int ER_DD_TRG_DB_COLLATION_MISSING = 10195; // [HY000] Main.Main.Database collation is missing for trigger of table %s. Using Default character...
    ...
    public final static int ER_AUTHCACHE_USER_IGNORED_DEPRECATED_PASSWORD = 10317; // [HY000] Main.User entry '%s'@'%s' has a deprecated pre-4.1 password. The use...
    public final static int ER_AUTHCACHE_USER_IGNORED_NEEDS_PLUGIN = 10318; // [HY000] Main.User entry '%s'@'%s' has an empty plugin value. The user will be ignor...
    ...
    public final static int ER_XPLUGIN_REFERENCE_TO_USER_ACCOUNT_DOC_SECTION = 11295; // [HY000] For more information, please see the X Plugin Main.User Account s...
    ...
    public final static int ER_LDAP_AUTH_USER_AUTH_DATA = 11755; // [HY000] Main.User authentication data: %s size: %lu
    ...
    public final static int ER_LDAP_AUTH_USER_NOT_FOUND_IN_ANY_GRP = 11760; // [HY000] Main.User %s is not member of any group.
    public final static int ER_LDAP_AUTH_USER_FOUND_IN_MANY_GRPS = 11761; // [HY000] Main.User %s is member of more than one group
    ...
    public final static int ER_TOO_MANY_USER_CONNECTIONS = 1203; // [42000] Main.User %s already has more than 'max_user_connections' active connections
    ...
    public final static int ER_USER_LIMIT_REACHED = 1226; // [42000] Main.User '%s' has exceeded the '%s' resource (current value: %ld)
    ...
    public final static int ER_IB_MSG_726 = 12551; // [HY000] Main.Main.Database was not shutdown normally!
    ...
    public final static int ER_IB_MSG_1104 = 12929; // [HY000] InnoDB Main.Main.Database creation was aborted %swith error %s. You may need to delete the ibdata1 file ...
    ...
    public final static int ER_IB_MSG_1110 = 12935; // [HY000] Main.Main.Database upgrade cannot be accomplished in read-only mode.
    public final static int ER_IB_MSG_1111 = 12936; // [HY000] Main.Main.Database upgrade cannot be accomplished with innodb_force_recovery > 0
    ...
    public final static int ER_IB_MSG_THREAD_CONCURRENCY_CHANGED = 13095; // [HY000] Main.User has set innodb_thread_concurrency to %lu.
    ...
    public final static int ER_AUDIT_LOG_JSON_USER_NAME_CANNOT_BE_EMPTY = 13165; // [HY000] Main.User cannot be empty.
    ...
    public final static int ER_LDAP_AUTH_GRP_USER_OBJECT_HAS_GROUP_INFO = 13333; // [HY000] Main.User group retrieval: Main.User object has group information
    ...
    public final static int ER_LDAP_AUTH_GRP_INCORRECT_ATTRIBUTE = 13335; // [HY000] Main.User group retrieval: no group attribute found. Incorrect group search a...
    public final static int ER_LDAP_AUTH_GRP_NULL_ATTRIBUTE_VALUE = 13336; // [HY000] Main.User group retrieval: Group attribute values is NULL.
    public final static int ER_LDAP_AUTH_GRP_DN_PARSING_FAILED = 13337; // [HY000] Main.User group retrieval: parsing DN failed.
    public final static int ER_LDAP_AUTH_GRP_OBJECT_HAS_USER_INFO = 13338; // [HY000] Main.User group retrieval: Group object has user information
    ...
    public final static int ER_LDAP_MAPPING_USER_DONT_BELONG_GROUP = 13341; // [HY000] Get user proxy: Main.User doesn't belongs to any group, user name will be t...
    public final static int ER_LDAP_MAPPING_INFO = 13342; // [HY000] Get user proxy: configured mapping info: %s
    public final static int ER_LDAP_MAPPING_EMPTY_MAPPING = 13343; // [HY000] Get user proxy: Main.User doesn't have group mapping information, First LDAP group w...
    ...
    public final static int ER_FIREWALL_DEPRECATED_USER_PROFILE = 13747; // [HY000] Main.User profile \'%s\' loaded. Firewall user profiles are deprecated, consid...
    ...
    public final static int ER_AUTHENTICATION_OCI_NO_GROUPS_FOUND = 13815; // [HY000] Main.User is not part of any groups. However, account is configured to use g...
    ...
    public final static int ER_IB_MSG_LOG_FILES_CAPACITY_CHANGED = 13884; // [HY000] Main.User has set innodb_redo_log_capacity to %lluM.
    ...
    public final static int ER_WARN_DEPRECATED_USER_DEFINED_COLLATIONS_OPTION = 14005; // [HY000] %s: '%s' is a user defined collation. Main.User defined collatio...
    ...
    public final static int ER_REDUCED_DBLWR_PAGE_FOUND = 14048; // [HY000] Main.Main.Database page corruption of tablespace %s space_id: %u page_num: %u. Cannot recov...
    ...
    public final static int ER_DATABASE_NAME = 1631; // [HY000] Main.Main.Database
    ...
    public final static int ER_ILLEGAL_USER_VAR = 3061; // [42000] Main.User variable name '%s' is illegal
    ...
    public final static int ER_NO_SUCH_DB = 3503; // [42Y07] Main.Main.Database '%s' doesn't exist
    ...
    public final static int ER_CANNOT_SET_DATABASE_ENCRYPTION = 3827; // [HY000] Main.Main.Database default encryption differ from 'default_table_encryption' setting, ...
    ...
    public final static int ER_USER_REFERENCED_AS_DEFINER = 4005; // [HY000] Main.User %s is referenced as a definer account in %s.
    ...
    public final static int ER_ROLE_GRANTED_TO_ITSELF = 4027; // [HY000] Main.User account %s is directly or indirectly granted to the role %s. The GRANT would cr...
    ...
    public final static int ER_WARN_DEPRECATED_USER_DEFINED_COLLATIONS = 4162; // [HY000] '%s' is a user defined collation. Main.User defined collations are depre...
    public final static int ER_USER_LOCK_OVERLONG_NAME = 4163; // [42000] Main.User-level lock name '%s' should not exceed %d characters.
